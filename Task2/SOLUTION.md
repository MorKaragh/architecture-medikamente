...
Ниже — **новые или существенно перестроенные** блоки относительно текущего (AS-IS) ландшафта, описанного в Task1. На контекстной диаграмме часть из них показана как отдельные программные системы (граница доверия или внешний поставщик); при детализации до **Container** они «проваливаются» внутрь платформы «Медикаменте» или смежного контура.
